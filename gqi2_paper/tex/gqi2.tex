...
\title[GQI2]{Generalized Q-sampling imaging with the spherical deconvolution transform}
...
\begin{verbatim}
0. Find the focus and real message of this paper.
1. Acquisition range (Multi-shell & Grid)
2. High anglular resolution
3. Speed Advantage
4. Reproduce Mic's table with timings etc.
5. Does it work for the single shell?
6. Contact Sylvain for multishell
7. Denoising?. 
